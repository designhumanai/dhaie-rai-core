...
[![Коммерческий класс](https://img.shields.io/badge/Статус-Коммерциализация-8A2BE2.svg?style=for-the-badge)](#коммерческое-предложение)
...
**DHAIE RAI теперь доступен как коммерческая платформа** с чётким разделением компонентов:
